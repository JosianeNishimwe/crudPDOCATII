...
if(isset($_POST['submit']))
  {
    ...
    $img="./imges/".basename($_FILES['photo']['name']);
...
$msg="This email  associated with another account";
    	...
    	$data[':fname'=>$fname,':mobno'=>$mobno, ':email'=>$email, ':password'=>$password, ':img'=>$img];
    $query='insert into tbluser setFullName=:fname, MobileNumber=:mobno, Email=:email,  Password=:password,imgs=:img,';
    $stat=prepare($query);
    $stat->execute($data);
		...
		<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			<div class="login-panel panel panel-default">
				...
				<div class="panel-body">
					<form role="form" action="" method="post" id="" name="signup" onsubmit="return checkpass();" enctype="multipart/form-data">
    ...
    echo $msg;
						...
						<fieldset>
							...
							<div class="form-group">
								...
								<input type="file" class="form-control"  name="photo" placeholder="attach photo">
							</div>
							<div class="checkbox">
