...
$ret='SELECT year(ExpenseDate) as rptyear,SUM(ExpenseCost) as totalyear FROM tblexpense  where (ExpenseDate BETWEEN :fdate and :tdate) && (UserId=:userid) group by year(ExpenseDate)';
