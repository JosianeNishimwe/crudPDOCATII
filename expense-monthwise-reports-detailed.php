...
$data=[':fdate'=>$fdate,':tdate'=>$tdate,':userid'=>$userid];
$ret='SELECT month(ExpenseDate) as rptmonth,year(ExpenseDate) as rptyear,SUM(ExpenseCost) as totalmonth FROM tblexpense  where (ExpenseDate BETWEEN :fdate and :tdate) && (UserId=:userid) group by month(ExpenseDate),year(ExpenseDate)';
