...
if (strlen($_SESSION['detsuid']==0)) {
  ...
  $mobno=$_POST['contactnumber'];
  	$data=[':fullname'=>$fullname, ':mobno'=>$mobno, 'userid'=>$userid];
     $query='update tbluser set FullName =:fullname, MobileNumber=:mobno where ID=:userid';
...
$userid=$_SESSION['detsuid'];
$data =[':userid'=>$userid];
$ret='select * from tbluser where ID=:userid';
$ps = $conn->prepare($ret);

$ps->execute($data);

$fet=$ps->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
foreach($fet as $row):
